...
return [
    ...
    "credential" => env('AZURE_CREDENTIAL', 'default'),
    ...
    "credentials" => [
        ...
        "default" => [
            ...
            "cache" => [
                // You may store the credential specific cache info here!
            ]
        ],

        // Add other application identities here if needed...
     ...
     * access tokens.
     *
     * You may overwrite these values for each credential by specifying
     * a `cache` key in the credential configuration.
     *
     */

    "cache" => [
        "enabled" => env('AZURE_CREDENTIALS_CACHE_ENABLED', false),
